...
(function () {
  const DICT = {
    en: {
      ...
      data_del:"<strong>Data deletion:</strong> to request removal of any data the tool holds, use our <a href=\"./contact.html\">contact form</a>. Authorization can also be revoked at any time from the connected account's settings, which immediately stops all access.",
      ...
      ct_h1:"Write to us",
      ct_sub:"Questions, collaboration, or a data-deletion request — write below. Leave a contact and we'll reply.",
      ct_cat:"Topic", ct_cat_question:"Question", ct_cat_collab:"Collaboration", ct_cat_deletion:"Data deletion", ct_cat_other:"Other",
      ct_msg:"Message", ct_msg_ph:"Your message…",
      ct_contact:"How can we reach you back?", ct_optional:"(optional)", ct_contact_ph:"Email or @telegram",
      ct_name:"Name", ct_name_ph:"Your name",
      ct_send:"Send", ct_sending:"Sending…",
      ct_ok:"Thanks! We received your message and will reply if you left a contact.",
      ct_err:"Could not send. Please try again in a moment.",
      ct_rate:"Too many messages from your network. Please try again later.",
      ct_short:"Message is too short (at least 20 characters).",
      ct_privacy:"We store your message only to respond to you. See our <a href=\"./privacy.html\">Privacy Policy</a>."
    },
    uk: {
      ...
      data_del:"<strong>Видалення даних:</strong> щоб видалити будь-які дані, які тримає інструмент, скористайся <a href=\"./contact.html\">формою звернення</a>. Доступ також можна відкликати будь-коли в налаштуваннях акаунта — це миттєво зупиняє доступ.",
      ...
      ct_h1:"Написати нам",
      ct_sub:"Питання, співпраця чи запит на видалення даних — пиши нижче. Лиши контакт, і ми відповімо.",
      ct_cat:"Тема", ct_cat_question:"Питання", ct_cat_collab:"Співпраця", ct_cat_deletion:"Видалення даних", ct_cat_other:"Інше",
      ct_msg:"Повідомлення", ct_msg_ph:"Твоє повідомлення…",
      ct_contact:"Як тобі відповісти?", ct_optional:"(необов'язково)", ct_contact_ph:"Email або @telegram",
      ct_name:"Ім'я", ct_name_ph:"Твоє ім'я",
      ct_send:"Надіслати", ct_sending:"Надсилаю…",
      ct_ok:"Дякуємо! Ми отримали повідомлення й відповімо, якщо ти лишив контакт.",
      ct_err:"Не вдалося надіслати. Спробуй за мить.",
      ct_rate:"Забагато повідомлень із твоєї мережі. Спробуй пізніше.",
      ct_short:"Повідомлення замало (мінімум 20 символів).",
      ct_privacy:"Ми зберігаємо повідомлення лише щоб відповісти. Див. <a href=\"./privacy.html\">Політику приватності</a>."
    },
    es: {
      ...
      data_del:"<strong>Eliminación de datos:</strong> para solicitar la eliminación de cualquier dato, usa nuestro <a href=\"./contact.html\">formulario de contacto</a>. También puedes revocar el acceso en cualquier momento desde la configuración de la cuenta.",
      ...
      ct_h1:"Escríbenos",
      ct_sub:"Preguntas, colaboración o una solicitud de eliminación de datos — escribe abajo. Deja un contacto y te responderemos.",
      ct_cat:"Tema", ct_cat_question:"Pregunta", ct_cat_collab:"Colaboración", ct_cat_deletion:"Eliminación de datos", ct_cat_other:"Otro",
      ct_msg:"Mensaje", ct_msg_ph:"Tu mensaje…",
      ct_contact:"¿Cómo te respondemos?", ct_optional:"(opcional)", ct_contact_ph:"Email o @telegram",
      ct_name:"Nombre", ct_name_ph:"Tu nombre",
      ct_send:"Enviar", ct_sending:"Enviando…",
      ct_ok:"¡Gracias! Recibimos tu mensaje y te responderemos si dejaste un contacto.",
      ct_err:"No se pudo enviar. Inténtalo en un momento.",
      ct_rate:"Demasiados mensajes desde tu red. Inténtalo más tarde.",
      ct_short:"El mensaje es demasiado corto (mínimo 20 caracteres).",
      ct_privacy:"Guardamos tu mensaje solo para responderte. Consulta nuestra <a href=\"./privacy.html\">Política de privacidad</a>."
    },
    de: {
      ...
      data_del:"<strong>Datenlöschung:</strong> um die Löschung von Daten zu beantragen, nutze unser <a href=\"./contact.html\">Kontaktformular</a>. Der Zugriff kann auch jederzeit in den Kontoeinstellungen widerrufen werden.",
      ...
      ct_h1:"Schreib uns",
      ct_sub:"Fragen, Zusammenarbeit oder eine Anfrage zur Datenlöschung — schreib unten. Hinterlasse einen Kontakt, und wir antworten.",
      ct_cat:"Thema", ct_cat_question:"Frage", ct_cat_collab:"Zusammenarbeit", ct_cat_deletion:"Datenlöschung", ct_cat_other:"Sonstiges",
      ct_msg:"Nachricht", ct_msg_ph:"Deine Nachricht…",
      ct_contact:"Wie erreichen wir dich?", ct_optional:"(optional)", ct_contact_ph:"E-Mail oder @telegram",
      ct_name:"Name", ct_name_ph:"Dein Name",
      ct_send:"Senden", ct_sending:"Senden…",
      ct_ok:"Danke! Wir haben deine Nachricht erhalten und antworten, wenn du einen Kontakt hinterlassen hast.",
      ct_err:"Konnte nicht gesendet werden. Bitte versuche es gleich erneut.",
      ct_rate:"Zu viele Nachrichten aus deinem Netzwerk. Bitte später erneut.",
      ct_short:"Nachricht ist zu kurz (mindestens 20 Zeichen).",
      ct_privacy:"Wir speichern deine Nachricht nur, um dir zu antworten. Siehe unsere <a href=\"./privacy.html\">Datenschutzerklärung</a>."
    }
  };
